...
namespace StaticCodeAnalysisClient.StaticCodeAnalysisService {
    ...
    public partial class GatingResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools ToolField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools Tool {
            get {
    ...
    public interface IStaticCodeAnalysisService {
        ...
        bool InvokeTool(string path, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStaticCodeAnalysisService/InvokeTool", ReplyAction="http://tempuri.org/IStaticCodeAnalysisService/InvokeToolResponse")]
        System.Threading.Tasks.Task<bool> InvokeToolAsync(string path, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool);
        ...
        StaticCodeAnalysisClient.StaticCodeAnalysisService.AnalysisReport[] ParseReport(StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string path, string branch);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStaticCodeAnalysisService/ParseReport", ReplyAction="http://tempuri.org/IStaticCodeAnalysisService/ParseReportResponse")]
        System.Threading.Tasks.Task<StaticCodeAnalysisClient.StaticCodeAnalysisService.AnalysisReport[]> ParseReportAsync(StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string path, string branch);
        ...
        bool GetResult(int threshold, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string repository, string branch);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStaticCodeAnalysisService/GetResult", ReplyAction="http://tempuri.org/IStaticCodeAnalysisService/GetResultResponse")]
        System.Threading.Tasks.Task<bool> GetResultAsync(int threshold, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string repository, string branch);
        ...
        StaticCodeAnalysisClient.StaticCodeAnalysisService.GatingResult[] GetRecentResults(string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStaticCodeAnalysisService/GetRecentResults", ReplyAction="http://tempuri.org/IStaticCodeAnalysisService/GetRecentResultsResponse")]
        System.Threading.Tasks.Task<StaticCodeAnalysisClient.StaticCodeAnalysisService.GatingResult[]> GetRecentResultsAsync(string username);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStaticCodeAnalysisServiceChannel : StaticCodeAnalysisClient.StaticCodeAnalysisService.IStaticCodeAnalysisService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StaticCodeAnalysisServiceClient : System.ServiceModel.ClientBase<StaticCodeAnalysisClient.StaticCodeAnalysisService.IStaticCodeAnalysisService>, StaticCodeAnalysisClient.StaticCodeAnalysisService.IStaticCodeAnalysisService {
        ...
        public bool InvokeTool(string path, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool) {
            return base.Channel.InvokeTool(path, tool);
        }
        
        public System.Threading.Tasks.Task<bool> InvokeToolAsync(string path, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool) {
            return base.Channel.InvokeToolAsync(path, tool);
        }
        
        public StaticCodeAnalysisClient.StaticCodeAnalysisService.AnalysisReport[] ParseReport(StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string path, string branch) {
            return base.Channel.ParseReport(tool, path, branch);
        }
        
        public System.Threading.Tasks.Task<StaticCodeAnalysisClient.StaticCodeAnalysisService.AnalysisReport[]> ParseReportAsync(StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string path, string branch) {
            return base.Channel.ParseReportAsync(tool, path, branch);
        }
        
        public bool GetResult(int threshold, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string repository, string branch) {
            return base.Channel.GetResult(threshold, tool, repository, branch);
        }
        
        public System.Threading.Tasks.Task<bool> GetResultAsync(int threshold, StaticCodeAnalysisClient.StaticCodeAnalysisService.Tools tool, string repository, string branch) {
            return base.Channel.GetResultAsync(threshold, tool, repository, branch);
        }
        
        public StaticCodeAnalysisClient.StaticCodeAnalysisService.GatingResult[] GetRecentResults(string username) {
            return base.Channel.GetRecentResults(username);
        }
        
        public System.Threading.Tasks.Task<StaticCodeAnalysisClient.StaticCodeAnalysisService.GatingResult[]> GetRecentResultsAsync(string username) {
